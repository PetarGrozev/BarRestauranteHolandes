...
const CreateProductPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      pushToast({ message: 'Product is succesvol aangemaakt.', title: 'Product', variant: 'success' });
      router.push('/admin/products');
    } catch (error) {
      pushToast({
        message: error instanceof Error && error.message !== 'Failed' ? error.message : 'Product aanmaken is mislukt.',
        title: 'Product',
        variant: 'error',
      });
    } finally {
  ...
  return (
    <div className="form-page">
      <div className="product-form-header">
        <h1>Nieuw product</h1>
        <p className="page-subtitle">Vul de gegevens in en controleer de voorbeeldweergave voordat je opslaat.</p>
      </div>
        ...
        <form className="form-card product-form-card" onSubmit={handleSubmit}>
          <div className="product-form-grid">
            ...
            <div className="form-field">
              ...
              <p className="form-help-text">Bij 0 is het product niet meer op voorraad.</p>
            </div>
            <div className="form-field">
          ...
          <div className="form-actions product-form-actions">
            <button className="btn-primary" type="submit" disabled={submitting}>
              {submitting ? 'Aanmaken...' : 'Product aanmaken'}
            </button>
